...
\begin{document}
	...
	\item[[ 4.]] \begin{enumerate}
		...
		\begin{align*}
			...
			$\Rightarrow$ \int_{-1/2}^{1/2} \text{exp}(2\pi i \lambda k) f_S(\lambda) d\lambda &= \int_{-1/2}^{1/2} |A_SQ(\lambda)|^2 \text{exp}(2\pi i \lambda k) f_Q(\lambda)\\
			$\Rightarrow$ f_S(\lambda) = |A_SQ(\lambda)|^2 \frac{\text{exp}(2\pi \lambda k)}{\text{exp}(2\pi \lambda k} f_Q(\lambda) \\
			$\Rightarrow$ |A_SQ(\lambda)|^2 f_Q(\lambda)
		\end{align*}
		\end{enumerate}
	\end{enumerate}
